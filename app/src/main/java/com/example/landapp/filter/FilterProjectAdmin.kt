...
class FilterProjectAdmin(
    list : ArrayList<Project>,
    adapter : AdapterProjectAdmin
) : Filter() {
    var filterList : ArrayList<Project> = list
    private var adapterProjectAdmin : AdapterProjectAdmin = adapter
    ...
    override fun publishResults(p0: CharSequence, p1: FilterResults) {
        adapterProjectAdmin.projectList = p1.values as ArrayList<Project>
        adapterProjectAdmin.notifyDataSetChanged()
    }
